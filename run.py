...
if __name__ == "__main__":
    ...
    parser.add_argument('--heuristic_function', type=str, default='euclidean', nargs='?',
                        help='heuristic function used by A* pursuer')

    args = parser.parse_args()

    env = Environment.from_file()

    e_start_state = np.array([12, 5])
    # e_start_state = np.array([7, 18])
